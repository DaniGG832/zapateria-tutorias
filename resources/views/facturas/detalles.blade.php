        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <a href="{{route('facturas.index')}}">
                    <button class="bg-blue-400 mt-4 ml-96 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                        Volver a facturas
                    </button>
                </a>
                <div class="p-6 bg-white border-b border-gray-200">

                    <p class="text-gray-500">Nombre usuario: <span
                            class="text-blue-900">{{ ' ' . Auth::user()->name }}</span></p>
                    <p class="text-gray-500">Email: <span class="text-blue-800">{{ ' ' . Auth::user()->email }}</span></p>
                    <p class="text-gray-500">Numero de factura:<span
                            class="text-blue-800">{{ ' ' . $factura->id }}</span></p>
                    <p class="text-gray-500">fecha factura:<span
                            class="text-blue-800">{{ ' ' . $factura->created_at }}</span></p>
                        ...
                        <table class="table-auto border-separate border border-blue-100 mt-4">
                            ...
                            <tbody>
                                ...
                                <tr class="m-96 ">
                                    <td></td>
                                    <td></td>
                                    <td class="text-center font-semibold border-2 border-blue-400">IVA<span
                                            class="text-sm text-gray-500"> 21%</span></td>
                                    <td class="text-center text-lg font-semibold border-2 border-blue-600 w-44">
                                        {{ $iva . ' €' }}</td>
                                ...
                                <tr class="m-96 ">
                                    <td></td>
                                    <td></td>
                                    <td class="text-center text-xl font-semibold bg-blue-200 border-2 border-blue-800">
                                        Total</td>
                                    <td class="text-center text-xl font-bold bg-blue-400 border-2 border-blue-800 w-44">
                                        {{ $total . ' €' }}</td>
